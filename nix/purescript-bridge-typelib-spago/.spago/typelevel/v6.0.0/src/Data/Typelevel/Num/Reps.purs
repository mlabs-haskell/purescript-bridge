...
instance showD0 :: Show D0 where
  show _ = "0"

instance showD1 :: Show D1 where
  show _ = "1"

instance showD2 :: Show D2 where
  show _ = "2"

instance showD3 :: Show D3 where
  show _ = "3"

instance showD4 :: Show D4 where
  show _ = "4"

instance showD5 :: Show D5 where
  show _ = "5"

instance showD6 :: Show D6 where
  show _ = "6"

instance showD7 :: Show D7 where
  show _ = "7"

instance showD8 :: Show D8 where
  show _ = "8"

instance showD9 :: Show D9 where
  show _ = "9"
