...
instance natD0 :: Nat D0 where
  toInt _ = 0

instance natD1 :: Nat D1 where
  toInt _ = 1

instance natD2 :: Nat D2 where
  toInt _ = 2

instance natD3 :: Nat D3 where
  toInt _ = 3

instance natD4 :: Nat D4 where
  toInt _ = 4

instance natD5 :: Nat D5 where
  toInt _ = 5

instance natD6 :: Nat D6 where
  toInt _ = 6

instance natD7 :: Nat D7 where
  toInt _ = 7

instance natD8 :: Nat D8 where
  toInt _ = 8

instance natD9 :: Nat D9 where
  toInt _ = 9

instance posNatD0 :: Pos x => Nat (x :* D0) where
  toInt n = subLastDec n

instance posNatD1 :: Pos x => Nat (x :* D1) where
  toInt n = subLastDec n + 1

instance posNatD2 :: Pos x => Nat (x :* D2) where
  toInt n = subLastDec n + 2

instance posNatD3 :: Pos x => Nat (x :* D3) where
  toInt n = subLastDec n + 3

instance posNatD4 :: Pos x => Nat (x :* D4) where
  toInt n = subLastDec n + 4

instance posNatD5 :: Pos x => Nat (x :* D5) where
  toInt n = subLastDec n + 5

instance posNatD6 :: Pos x => Nat (x :* D6) where
  toInt n = subLastDec n + 6

instance posNatD7 :: Pos x => Nat (x :* D7) where
  toInt n = subLastDec n + 7

instance posNatD8 :: Pos x => Nat (x :* D8) where
  toInt n = subLastDec n + 8

instance posNatD9 :: Pos x => Nat (x :* D9) where
  toInt n = subLastDec n + 9
