...
var toDataBoolean = {
    toData: function (v) {
        ...
        throw new Error("Failed pattern match at ToData (line 255, column 1 - line 257, column 30): " + [ v.constructor.name ]);
    }
};
var toDataBigInt = {
        ...
        return {
            toDataWithSchema: function (p) {
                return function (v) {
                    ...
                    throw new Error("Failed pattern match at ToData (line 137, column 1 - line 143, column 54): " + [ p.constructor.name, v.constructor.name ]);
                };
            }
        };
    };
...
var toDataArray = function (dictToData) {
    return {
        toData: (function () {
            var $126 = Data_Functor.map(Data_Functor.functorArray)(toData(dictToData));
            return function ($127) {
                return Types_PlutusData.List.create($126($127));
            };
        })()
    };
};
    ...
    return function (dictToData1) {
        return {
            toData: function (v) {
                ...
                throw new Error("Failed pattern match at ToData (line 263, column 1 - line 265, column 45): " + [ v.constructor.name ]);
            }
        };
    };
};
var toDataInt = function (dictFail) {
    return {
        toData: (function () {
            var $128 = toData(toDataBigInt);
            return function ($129) {
                return $128(Data_BigInt.fromInt($129));
            };
        })()
    };
};
    ...
    return function (dictToData1) {
        return {
            toData: function (mp) {
                ...
                return Types_PlutusData["Map"].create(Data_Functor.map(Data_Functor.functorArray)(Data_Profunctor_Strong.splitStrong(Control_Category.categoryFn)(Data_Profunctor_Strong.strongFn)(toData(dictToData))(toData(dictToData1)))(entries));
            }
        };
    };
};
var toDataMaybe = function (dictToData) {
    return {
        toData: function (v) {
            ...
            throw new Error("Failed pattern match at ToData (line 259, column 1 - line 261, column 33): " + [ v.constructor.name ]);
        }
    };
};
...
var toDataString = {
    toData: (function () {
        var $130 = toData(toDataByteArray);
        return function ($131) {
            return $130(Types_ByteArray.ByteArray(Data_TextEncoder.encodeUtf8($131)));
        };
    })()
};
...
var toDataUInt = {
    toData: (function () {
        ...
        return function ($133) {
            return $132(Helpers.uIntToBigInt($133));
        };
    })()
};
var genericToData = function (dictGeneric) {
    return function (dictToDataWithSchema) {
        var $134 = toDataWithSchema(dictToDataWithSchema)(Type_Proxy["Proxy"].value);
        var $135 = Data_Generic_Rep.from(dictGeneric);
        return function ($136) {
            return $134($135($136));
        };
    };
...
var foldableToPlutusData = function (dictFoldable) {
    return function (dictToData) {
        var $137 = Data_Functor.map(Data_Functor.functorArray)(toData(dictToData));
        var $138 = Data_Array.fromFoldable(dictFoldable);
        return function ($139) {
            return Types_PlutusData.List.create($137($138($139)));
        };
    };
};
