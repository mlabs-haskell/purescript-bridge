...
var genericTypeCheckError_ = {
    to: function (x) {
        ...
        throw new Error("Failed pattern match at Types.TypedTxOut (line 199, column 1 - line 199, column 41): " + [ x.constructor.name ]);
    },
    from: function (x) {
...
var ordTypeCheckError = {
    compare: function (x) {
        return function (y) {
            ...
            throw new Error("Failed pattern match at Types.TypedTxOut (line 201, column 1 - line 201, column 35): " + [ x.constructor.name, y.constructor.name ]);
        };
    },
    Eq0: function () {
...
var typedTxOutRefDatumHash = function (dictDatumType) {
    return function (dictFromData) {
        return function (dictToData) {
            return function (v) {
                return typedTxOutDatumHash()(dictFromData)(dictToData)(v.typedTxOut);
            };
        };
    };
};
...
var typedTxOutRefAddress = function (dictDatumType) {
    return function (dictFromData) {
        return function (dictToData) {
            return function (v) {
                return typedTxOutAddress()(dictFromData)(dictToData)(v.typedTxOut);
            };
        };
    };
};
                ...
                return function (typedVal) {
                    return function (dt) {
                        return function (amount) {
                            var mkTypedTxOut$prime = function (txOut) {
                                return function (dat) {
                                    return {
                                        txOut: txOut,
                                        data: dat
                            ...
                            return Control_Bind.bind(Control_Monad_Reader_Trans.bindReaderT(Control_Monad_Logger_Trans.bindLoggerT(Effect_Aff.monadAff)))(QueryM.datumHash(Types_Datum.Datum(ToData.toData(dictToData)(dt))))(function (mDHash) {
                                var address = Scripts.typedValidatorEnterpriseAddress(networkId)(typedVal);
                                return Control_Applicative.pure(Control_Monad_Reader_Trans.applicativeReaderT(Control_Monad_Logger_Trans.applicativeLoggerT(Effect_Aff.monadAff)))(Data_Maybe.maybe(Data_Maybe.Nothing.value)(function (dHash) {
                                    return Data_Maybe.Just.create(mkTypedTxOut$prime(Data_Newtype.wrap()({
                                        address: address,
                                        amount: amount,
                                        dataHash: Control_Applicative.pure(Data_Maybe.applicativeMaybe)(dHash)
                                    }))(dt));
                                })(mDHash));
                            });
                        };
                        ...
                        return Control_Monad_Except_Trans.runExceptT(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Reader_Trans.monadReaderT(Control_Monad_Logger_Trans.monadLoggerT(Effect_Aff.monadAff))))(Helpers.liftM(Control_Monad_Except_Trans.monadErrorExceptT(Control_Monad_Reader_Trans.monadReaderT(Control_Monad_Logger_Trans.monadLoggerT(Effect_Aff.monadAff))))(ExpectedScriptGotPubkey.value)(v.dataHash))(function (dHash) {
                            return Control_Bind.discard(Control_Bind.discardUnit)(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Reader_Trans.monadReaderT(Control_Monad_Logger_Trans.monadLoggerT(Effect_Aff.monadAff))))(Data_Functor["void"](Control_Monad_Except_Trans.functorExceptT(Control_Monad_Reader_Trans.functorReaderT(Control_Monad_Logger_Trans.functorLoggerT(Effect_Aff.functorAff))))(checkValidatorAddress(Control_Monad_Except_Trans.monadExceptT(Control_Monad_Reader_Trans.monadReaderT(Control_Monad_Logger_Trans.monadLoggerT(Effect_Aff.monadAff))))(networkId)(typedVal)(v.address)))(function () {
                                return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Reader_Trans.monadReaderT(Control_Monad_Logger_Trans.monadLoggerT(Effect_Aff.monadAff))))(Control_Monad_Except_Trans.ExceptT(Data_Functor.mapFlipped(Control_Monad_Reader_Trans.functorReaderT(Control_Monad_Logger_Trans.functorLoggerT(Effect_Aff.functorAff)))(QueryM.getDatumByHash(dHash))(Data_Either.note(new CannotQueryDatum(dHash)))))(function (pd) {
                                    return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Reader_Trans.monadReaderT(Control_Monad_Logger_Trans.monadLoggerT(Effect_Aff.monadAff))))(Control_Monad_Except_Trans.ExceptT(checkDatum(Control_Monad_Reader_Trans.monadReaderT(Control_Monad_Logger_Trans.monadLoggerT(Effect_Aff.monadAff)))()(dictFromData)(typedVal)(Data_Newtype.wrap()(pd))))(function (dtOut) {
                                        return Control_Monad_Except_Trans.ExceptT(Data_Functor.map(Control_Monad_Reader_Trans.functorReaderT(Control_Monad_Logger_Trans.functorLoggerT(Effect_Aff.functorAff)))(Data_Either.note(CannotMakeTypedTxOut.value))(mkTypedTxOut()(dictFromData)(dictToData)(networkId)(typedVal)(dtOut)(v.amount)));
                                    });
                                });
                            });
                        }));
                    ...
                    return function (typedVal) {
                        return function (txOutRef) {
                            return Control_Monad_Except_Trans.runExceptT(Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Reader_Trans.monadReaderT(Control_Monad_Logger_Trans.monadLoggerT(Effect_Aff.monadAff))))(Helpers.liftM(Control_Monad_Except_Trans.monadErrorExceptT(Control_Monad_Reader_Trans.monadReaderT(Control_Monad_Logger_Trans.monadLoggerT(Effect_Aff.monadAff))))(UnknownRef.value)(lookupRef(txOutRef)))(function (out) {
                                return Control_Bind.bind(Control_Monad_Except_Trans.bindExceptT(Control_Monad_Reader_Trans.monadReaderT(Control_Monad_Logger_Trans.monadLoggerT(Effect_Aff.monadAff))))(Control_Monad_Except_Trans.ExceptT(typeTxOut()(dictFromData)(dictToData)(networkId)(typedVal)(out)))(function (typedTxOut) {
