...
var genericPlutusData_ = {
    to: function (x) {
        ...
        throw new Error("Failed pattern match at Types.PlutusData (line 31, column 1 - line 31, column 37): " + [ x.constructor.name ]);
    },
    from: function (x) {
...
var ordPlutusData = {
    compare: function (x) {
        return function (y) {
            ...
            throw new Error("Failed pattern match at Types.PlutusData (line 30, column 1 - line 30, column 31): " + [ x.constructor.name, y.constructor.name ]);
        };
    },
    Eq0: function () {
        return eqPlutusData;
...
var decodeAesonPlutusData = {
    decodeAeson: function (aeson) {
        var decodeMap = Control_Bind.bind(Data_Either.bindEither)(Aeson.decodeAeson(Aeson.decodeAeson1(Foreign_Object.traversableObject)(Aeson.decodeAesonAeson)(Data_Argonaut_Decode_Class.decodeForeignObject(Data_Argonaut_Decode_Class.decodeJsonJson)))(aeson))(function (obj) {
            return Control_Bind.bind(Data_Either.bindEither)(Aeson.getField(Aeson.decodeAeson1(Data_Traversable.traversableArray)(Aeson.decodeAeson1(Foreign_Object.traversableObject)(Aeson.decodeAesonAeson)(Data_Argonaut_Decode_Class.decodeForeignObject(Data_Argonaut_Decode_Class.decodeJsonJson)))(Data_Argonaut_Decode_Class.decodeArray(Data_Argonaut_Decode_Class.decodeJsonJson)))(obj)("map"))(function (map1) {
        ...
        var decodeList = Data_Functor.map(Data_Either.functorEither)(List.create)(Aeson.decodeAeson(Aeson.decodeAeson1(Data_Traversable.traversableArray)(decodeAesonPlutusData)(Data_Argonaut_Decode_Class.decodeArray(Data_Argonaut_Decode_Class.decodeJsonJson)))(aeson));
        ...
        var decodeConstr = Control_Bind.bind(Data_Either.bindEither)(Aeson.decodeAeson(Aeson.decodeAeson1(Foreign_Object.traversableObject)(Aeson.decodeAesonAeson)(Data_Argonaut_Decode_Class.decodeForeignObject(Data_Argonaut_Decode_Class.decodeJsonJson)))(aeson))(function (x) {
            return Control_Bind.bind(Data_Either.bindEither)(Aeson.getField(Aeson.decodeAesonBigInt)(x)("constr"))(function (constr) {
                return Control_Bind.bind(Data_Either.bindEither)(Aeson.getField(Aeson.decodeAeson1(Data_Traversable.traversableArray)(decodeAesonPlutusData)(Data_Argonaut_Decode_Class.decodeArray(Data_Argonaut_Decode_Class.decodeJsonJson)))(x)("fields"))(function (fields) {
        ...
        var decodeBytes = Control_Bind.bind(Data_Either.bindEither)(Aeson.decodeAeson(Aeson.decodeAesonString)(aeson))(function (bytesHex) {
            ...
            if (v instanceof Data_Maybe.Nothing) {
                return Data_Either.Left.create(Data_Argonaut_Decode_Error.UnexpectedValue.create(Data_Argonaut_Encode_Class.encodeJson(Data_Argonaut_Encode_Class.encodeJsonJString)(bytesHex)));
            };
            if (v instanceof Data_Maybe.Just) {
                return Control_Applicative.pure(Data_Either.applicativeEither)(new Bytes(v.value0));
            };
            throw new Error("Failed pattern match at Types.PlutusData (line 71, column 7 - line 73, column 37): " + [ v.constructor.name ]);
        });
