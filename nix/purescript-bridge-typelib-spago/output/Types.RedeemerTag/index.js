...
var genericRedeemerTag_ = {
    to: function (x) {
        ...
        throw new Error("Failed pattern match at Types.RedeemerTag (line 13, column 1 - line 13, column 38): " + [ x.constructor.name ]);
    },
    from: function (x) {
...
var ordRedeemerTag = {
    compare: function (x) {
        return function (y) {
            ...
            throw new Error("Failed pattern match at Types.RedeemerTag (line 15, column 1 - line 15, column 32): " + [ x.constructor.name, y.constructor.name ]);
        };
    },
    Eq0: function () {
