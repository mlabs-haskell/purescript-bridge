...
var uIntToBigInt = (function () {
    ...
    return function ($28) {
        return $27(Data_BigInt.fromString(Data_UInt.toString($28)));
    };
})();
var maybeArrayMerge = function (dictEq) {
    return function (v) {
        return function (v1) {
            ...
            throw new Error("Failed pattern match at Helpers (line 100, column 1 - line 105, column 21): " + [ v.constructor.name, v1.constructor.name ]);
        };
    };
};
...
var liftM = function (dictMonadError) {
    return function (err) {
        var $29 = liftEither(dictMonadError);
        var $30 = Data_Maybe.maybe(Control_Monad_Error_Class.throwError(Control_Monad_Error_Class.monadThrowEither)(err))(Data_Either.Right.create);
        return function ($31) {
            return $29($30($31));
        };
    };
...
var liftMWith = function (dictMonadError) {
    return function (err) {
        return function (f) {
            var $32 = liftEither(dictMonadError);
            var $33 = Data_Maybe.maybe(Control_Monad_Error_Class.throwError(Control_Monad_Error_Class.monadThrowEither)(err))(function ($35) {
                return Data_Either.Right.create(f($35));
            });
            return function ($34) {
                return $32($33($34));
            };
...
var fromRightEff = function (dictShow) {
    return Data_Either.either((function () {
        var $36 = Data_Show.show(dictShow);
        return function ($37) {
            return Effect_Exception["throw"]($36($37));
        };
...
var fromJustEff = function (e) {
    return function (v) {
        ...
        throw new Error("Failed pattern match at Helpers (line 52, column 17 - line 54, column 19): " + [ v.constructor.name ]);
    };
};
var filterMapWithKeyM = function (dictOrd) {
    return function (dictMonad) {
        return function (p) {
            var $38 = Data_Functor.map(((dictMonad.Bind1()).Apply0()).Functor0())(Data_Map_Internal.fromFoldable(dictOrd)(Data_List_Lazy_Types.foldableList));
            var $39 = Data_List_Lazy.filterM(dictMonad)(Data_Tuple.uncurry(p));
            var $40 = Data_Map_Internal.toUnfoldable(Data_List_Lazy_Types.unfoldableList);
            return function ($41) {
                return $38($39($40($41)));
            };
        };
...
var filterMapM = function (dictOrd) {
    return function (dictMonad) {
        return function (p) {
            var $42 = Data_Functor.map(((dictMonad.Bind1()).Apply0()).Functor0())(Data_Map_Internal.fromFoldable(dictOrd)(Data_List_Lazy_Types.foldableList));
            var $43 = Data_List_Lazy.filterM(dictMonad)(function ($46) {
                return p(Data_Tuple.snd($46));
            });
            var $44 = Data_Map_Internal.toUnfoldable(Data_List_Lazy_Types.unfoldableList);
            return function ($45) {
                return $42($43($44($45)));
            };
        };
...
var bigIntToUInt = function ($47) {
    return Data_UInt.fromString(Data_BigInt.toString($47));
};
