    ...
    return function (mps) {
        var f$prime = function (v) {
            return function (v1) {
                ...
                throw new Error("Failed pattern match at Plutus.Types.AssocMap (line 174, column 28 - line 177, column 54): " + [ v.value1.constructor.name ]);
            };
        };
...
var member = function (dictEq) {
    return function (k) {
        var $133 = lookup(dictEq)(k);
        return function ($134) {
            return Data_Maybe.isJust($133($134));
        };
    };
};
        ...
        return function (v1) {
            ...
            var f = function (a) {
                return function (v2) {
                    ...
                    throw new Error("Failed pattern match at Plutus.Types.AssocMap (line 136, column 11 - line 138, column 25): " + [ v2.constructor.name ]);
                };
            };
...
var filter = function (f) {
    return function (v) {
        return $$Map(Data_Array.filter(function ($135) {
            return f(Data_Tuple.snd($135));
        })(v));
    };
};
var empty = [  ];
    ...
    return function (k) {
        return function (v) {
            var v1 = Control_Bind.bind(Data_Maybe.bindMaybe)(Data_Array.findIndex((function () {
                var $136 = Data_Eq.eq(dictEq)(k);
                return function ($137) {
                    return $136(Data_Tuple.fst($137));
                };
            ...
            throw new Error("Failed pattern match at Plutus.Types.AssocMap (line 118, column 3 - line 120, column 30): " + [ v1.constructor.name ]);
        };
    };
};
module.exports = {
