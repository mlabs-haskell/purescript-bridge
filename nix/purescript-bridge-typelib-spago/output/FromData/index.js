...
var genericFromDataError_ = {
    to: function (x) {
        ...
        throw new Error("Failed pattern match at FromData (line 79, column 1 - line 79, column 42): " + [ x.constructor.name ]);
    },
    from: function (x) {
...
var noteB = function (v) {
    return function (v1) {
        ...
        throw new Error("Failed pattern match at FromData (line 84, column 1 - line 84, column 59): " + [ v.constructor.name, v1.constructor.name ]);
    };
};
                ...
                if (v instanceof Types_PlutusData.Constr && v.value1.length === 1) {
                    if (Data_Eq.eq(Data_BigInt.eqBigInt)(v.value0)(Data_Semiring.zero(Data_BigInt.semiringBigInt))) {
                        return Data_Maybe.maybe(Data_Maybe.Nothing.value)(function ($258) {
                            return Data_Maybe.Just.create(Data_Either.Left.create($258));
                        })(fromData(dictFromData)(v["value1"][0]));
                    };
                    if (Data_Eq.eq(Data_BigInt.eqBigInt)(v.value0)(Data_Semiring.one(Data_BigInt.semiringBigInt))) {
                        return Data_Maybe.maybe(Data_Maybe.Nothing.value)(function ($259) {
                            return Data_Maybe.Just.create(Data_Either.Right.create($259));
            ...
            return {
                fromData: function (v) {
                    if (v instanceof Types_PlutusData["Map"]) {
                        return Data_Functor.map(Data_Maybe.functorMaybe)(Data_Map_Internal.fromFoldable(dictOrd)(Data_Foldable.foldableArray))(Data_Traversable["for"](Data_Maybe.applicativeMaybe)(Data_Traversable.traversableArray)(v.value0)(function (v1) {
                            return Control_Apply.apply(Data_Maybe.applyMaybe)(Data_Functor.map(Data_Maybe.functorMaybe)(Data_Tuple.Tuple.create)(fromData(dictFromData)(v1.value0)))(fromData(dictFromData1)(v1.value1));
                        }));
                    };
                    return Data_Maybe.Nothing.value;
                }
    ...
    return {
        fromData: function (v) {
            if (v instanceof Types_PlutusData.Constr && (v.value1.length === 1 && Data_Eq.eq(Data_BigInt.eqBigInt)(v.value0)(Data_Semiring.zero(Data_BigInt.semiringBigInt)))) {
                return Data_Maybe.maybe(Data_Maybe.Nothing.value)(function ($260) {
                    return Data_Maybe.Just.create(Data_Maybe.Just.create($260));
                })(fromData(dictFromData)(v["value1"][0]));
            };
