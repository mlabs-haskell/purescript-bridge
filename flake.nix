{
  ...
  outputs = inputs@{ self, flake-utils, haskell-nix, ... }:
    builtins.mapAttrs # FIXME: https://github.com/mlabs-haskell/purescript-bridge/issues/36
      (name: value: if name == "hydraJobs" then builtins.removeAttrs value [ "x86_64-darwin" ] else value)
