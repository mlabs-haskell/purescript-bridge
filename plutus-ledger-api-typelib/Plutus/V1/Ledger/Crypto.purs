...
instance EncodeAeson PubKey where
  encodeAeson' x = pure $ E.encode  (E.record {getPubKey: E.value :: _ (LedgerBytes) }) {getPubKey: unwrap x}
...
instance EncodeAeson PubKeyHash where
  encodeAeson' x = pure $ E.encode  (E.record {getPubKeyHash: E.value :: _ (ByteArray) }) {getPubKeyHash: unwrap x}
...
instance EncodeAeson PrivateKey where
  encodeAeson' x = pure $ E.encode  (E.record {getPrivateKey: E.value :: _ (LedgerBytes) }) {getPrivateKey: unwrap x}
...
instance EncodeAeson Signature where
  encodeAeson' x = pure $ E.encode  (E.record {getSignature: E.value :: _ (ByteArray) }) {getSignature: unwrap x}
