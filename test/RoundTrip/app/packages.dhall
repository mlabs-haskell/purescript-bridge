...
let ctlSpagoDhall = env:CTL_SPAGO_DHALL

let ctlSpagoDhallLocation = Location.Local env:CTL_SPAGO_DHALL as Text

let additions = { cardano-transaction-lib = ctlSpagoDhallLocation }

in  upstream // additions // ctlSpagoDhall.packages
