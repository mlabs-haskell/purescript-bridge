...
extremelyUnsafeMkSumType = case mkSumType @t of
  SumType tInfo constructors instances -> SumType tInfo constructors (instances <> (Generic : HasConstrIndex : ToData : FromData : maybeToList (nootype . map snd $ constructors)))
